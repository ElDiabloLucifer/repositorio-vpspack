...
valor2="127.0.0.1"
echo -e "${cor[1]} $bar ${cor[0]}"
echo -e "${cor[5]} Tipo de Metodo ${cor[3]}"
...
echo -e "${cor[1]} $bar ${cor[0]}"
read -p " Escriba un Proxy: " hostprox
read -p " Escriba un Puerto: " portx
echo -e "${cor[1]} $bar ${cor[0]}"
echo -e "${cor[1]} Comenzando... ${cor[0]}"
echo -e "${cor[1]} $bar ${cor[0]}"
}
while true; do
echo -e " [1]-Probar Un Payload"
echo -e " [2]-Probar Conexiones con Payloads"
echo -e "${cor[1]} $bar ${cor[0]}"
read -p " [1-2]: " opx
case $opx in
1)
read -p " Escriba un Payload: " payloadx
read -p " Escriba un Proxy: " hostprox
read -p " Escriba un Puerto: " portx
echo -e "${cor[1]} $bar ${cor[0]}"
